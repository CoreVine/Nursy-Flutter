...
class OnBoardingBody2 extends StatelessWidget {
  const OnBoardingBody2({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Image.asset(Assets.assetsImagesOnboardingBooking, fit: BoxFit.cover, width: context.width),
        SizedBox(height: 80.h),

        Center(child: Text(S.of(context).booking, style: AppTextStyles.ibmPlexSans16Bold(context))),
        Center(
          child: SizedBox(width: 120, child: Divider(height: 32.h, color: AppColors.lightGray)),
        ),
        Center(
          child: Text(
            S.of(context).on_spot_booking,
