...
class OnBoardingBody1 extends StatelessWidget {
  const OnBoardingBody1({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Image.asset(Assets.assetsImagesOnboardingCare, fit: BoxFit.cover, width: context.width),
        SizedBox(height: 80.h),

        Center(child: Text(S.of(context).care, style: AppTextStyles.ibmPlexSans16Bold(context))),
        Center(
          child: SizedBox(width: 120, child: Divider(height: 32.h, color: AppColors.lightGray)),
        ),
        Center(
          child: Text(
            S.of(context).home_nursing_care,
